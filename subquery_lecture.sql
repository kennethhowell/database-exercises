...
select concat(first_name, ' ', last_name) as 'This dudes name' from employees where emp_no = 111133;
...
from employees
    join salaries
        on salaries.emp_no = employees.employees.emp_no
...
select concat(first_name, ' ', last_name) as 'Employee Name', title
    from employees
